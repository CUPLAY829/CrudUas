...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sekolah=input($_POST["Nim"]);
        $jurusan=input($_POST["Kelas"]);
        $no_hp=input($_POST["Falkutas"]);
        $alamat=input($_POST["Alamat"]);

        //Query input menginput data kedalam tabel anggota
        $sql="insert into peserta (nama,nim,kelas,falkutas,alamat) values
		('$nama','$nim','$kelas','$falkutas','$alamat')";
